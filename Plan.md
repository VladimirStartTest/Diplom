...
18. Попытка покупки тура в кредит с невалидными данными в поле "Владелец"(Спецсимволы):
- на странице сервиса нажать кнопку "Купить в кредит".
- заполнить поле "Владелец" спецсимволами;
- остальные поля заполнить валидными данными;
- нажать кнопку "Продолжить"
...
20. Попытка покупки тура с пустой формой:
- на странице сервиса нажать кнопку "Купить".
...
21. Попытка покупки тура с пустым полем "Владелец":
- на странице сервиса нажать кнопку "Купить".
...
22. Попытка покупки тура с пустым полем "Номер карты":
- на странице сервиса нажать кнопку "Купить".
...
23. Попытка покупки тура с пустым полем "Месяц":
- на странице сервиса нажать кнопку "Купить".
...
24. Попытка покупки тура с пустым полем "Год":
- на странице сервиса нажать кнопку "Купить".
...
25. Попытка покупки тура с пустым полем "СVC/CVV":
- на странице сервиса нажать кнопку "Купить".
...
26. Попытка покупки тура в кредит с незаполненной формой:
- на странице сервиса нажать кнопку "Купить в кредит".
- оставить форму незаполненной и нажать кнопку "Продолжить".

*Ожидаемый результат*: Покупка не совершается. Пользователь видит сообщение: "Неверный формат".

27. Попытка покупки тура в кредит с пустым полем "Владелец":
- на странице сервиса нажать кнопку "Купить в кредит".
- оставить поле "Владелец" пустым
- остальные поля заполнить валидными данными;
- нажать кнопку "Продолжить".
...
28. Попытка покупки тура в кредит с пустым полем "Номер карты":
- на странице сервиса нажать кнопку "Купить в кредит".
- оставить поле "Номер карты" пустым
- остальные поля заполнить валидными данными;
- нажать кнопку "Продолжить".
...
29. Попытка покупки тура в кредит с пустым полем "Месяц":
- на странице сервиса нажать кнопку "Купить в кредит".
- оставить поле "Месяц" пустым
- остальные поля заполнить валидными данными;
- нажать кнопку "Продолжить".
...
30. Попытка покупки тура в кредит с пустым полем "Год":
- на странице сервиса нажать кнопку "Купить в кредит".
- оставить поле "Год" пустым
- остальные поля заполнить валидными данными;
- нажать кнопку "Продолжить".
...
31. Попытка покупки тура в кредит с пустым полем "СVC/CVV":
- на странице сервиса нажать кнопку "Купить в кредит".
- оставить поле "СVC/CVV" пустым
- остальные поля заполнить валидными данными;
- нажать кнопку "Продолжить".
